...
- **After adding or updating skills:** Run **`skillset sync`** (workspace) or **`skillset sync --user`** (user-level) to load skills to the configured tools (e.g. Cursor, Claude, Hermes)."#
}
